...
const player1 = new Player1(ctx, 150, canvas.height/3, background.platforms);
const player2 = new Player2(ctx, canvas.width - 150, canvas.height/3, background.platforms);
let Bodies = [player1, player2];
const game = new Game(canvas, ctx, player1, player2, keyboarder);
